...
public class BusinessVideoPlayAdapter extends BaseAdapter {
    ...
    public BusinessVideoPlayAdapter(Context context,  List<Video_List_Bean.DataBean.ItemsBean> items) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        Video_List_Bean.DataBean.ItemsBean itemsBean = items.get(position);
