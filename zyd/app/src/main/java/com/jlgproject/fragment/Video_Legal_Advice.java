...
public class Video_Legal_Advice extends BaseFragment implements View.OnClickListener, HttpMessageInfo.IMessage, PullToRefreshBase.OnRefreshListener2 {
    ...
    public int getLoadViewId() {
        return R.layout.video_legal_advice;
    }
