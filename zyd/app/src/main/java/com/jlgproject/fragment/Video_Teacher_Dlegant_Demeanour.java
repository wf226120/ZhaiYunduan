...
public class Video_Teacher_Dlegant_Demeanour extends BaseFragment implements View.OnClickListener, HttpMessageInfo.IMessage, PullToRefreshBase.OnRefreshListener2 {
    ...
    public int getLoadViewId() {
        return R.layout.video_teacher_dlegant_demeanour;
    }
