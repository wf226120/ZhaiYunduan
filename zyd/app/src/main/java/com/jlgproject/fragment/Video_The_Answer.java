...
public class Video_The_Answer extends BaseFragment implements View.OnClickListener, HttpMessageInfo.IMessage, PullToRefreshBase.OnRefreshListener2 {
    ...
    public int getLoadViewId() {
        return R.layout.video_the_answer;
    }
